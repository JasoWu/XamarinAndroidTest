...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Contoso.Android.Puppet.LogLevelActivity, Contoso.Android.Puppet", LogLevelActivity.class, __md_methods);
	}


	public LogLevelActivity ()
	{
		super ();
		if (getClass () == LogLevelActivity.class)
			mono.android.TypeManager.Activate ("Contoso.Android.Puppet.LogLevelActivity, Contoso.Android.Puppet", "", this, new java.lang.Object[] {  });
	}
