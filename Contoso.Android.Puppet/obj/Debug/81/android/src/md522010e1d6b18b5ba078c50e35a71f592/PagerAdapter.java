...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Contoso.Android.Puppet.PagerAdapter, Contoso.Android.Puppet", PagerAdapter.class, __md_methods);
	}
	...
	public PagerAdapter (android.support.v4.app.FragmentManager p0)
	{
		...
		if (getClass () == PagerAdapter.class)
			mono.android.TypeManager.Activate ("Contoso.Android.Puppet.PagerAdapter, Contoso.Android.Puppet", "Android.Support.V4.App.FragmentManager, Xamarin.Android.Support.Fragment", this, new java.lang.Object[] { p0 });
	}
